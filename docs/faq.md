...
[proposed subtract command]: https://github.com/appzic/google-wire/issues/8
...
There is an [open issue](https://github.com/appzic/google-wire/issues/242) to consider
improving this.
